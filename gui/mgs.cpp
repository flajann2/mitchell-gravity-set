...
int main(int ac, char* av[]) {
  ...
  widget->setWindowTitle(QStringLiteral("Mitchell Gravity Set"));
  ...
  auto arrowsSlider = new QSlider(Qt::Horizontal, widget);
